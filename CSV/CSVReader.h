...
public:
     ...
     * @throws
     *      illformed_file_exception: se il contentuo del file non è del formato supportato, o se contiene errori nel contenuto (es: se a un certo tipo, mancano dati necessari per la cotruzione di quel tipo)
     *      invalid_argument: se il path non è valido
    */
